#!/usr/bin/env python3
"""Interactively approve the frozen six-circuit Sirius scan."""
...
def main() -> None:
    ...
    # The structural validator requires approval.  Validate a temporary copy
    # with that single flag enabled, without changing the on-disk manifest.
    ...
    print(
        ...
        f"MOVE={manifest['maximum_move_error']:.6f} "
